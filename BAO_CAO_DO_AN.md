...
Trong những năm gần đây, nhu cầu thuê nhà trọ tại các đô thị lớn như Hà Nội và Thành phố Hồ Chí Minh liên tục gia tăng, chủ yếu đến từ sinh viên nhập học và người lao động từ các tỉnh thành di chuyển lên thành phố làm việc. Riêng tại Hà Nội, các khu vực tập trung nhiều trường đại học như Cầu Giấy, Thanh Xuân, Đống Đa luôn chịu áp lực tìm phòng lớn vào mỗi đầu năm học. Tuy nhiên, phần lớn người thuê hiện nay vẫn tìm phòng qua các kênh truyền thống như nhóm Facebook, tờ rơi dán tường hoặc hỏi người quen, đây là cách làm tốn thời gian và tiềm ẩn rủi ro do thông tin thiếu kiểm chứng.

Cụ thể, nội dung đăng tải trên nhiều nền tảng trực tuyến thường không qua kiểm duyệt, dẫn đến tình trạng tin giả, tin đã cho thuê nhưng vẫn còn hiển thị, hay hình ảnh không phản ánh đúng thực tế căn phòng. Khi muốn đến xem phòng, người thuê phải tự liên hệ từng chủ trọ qua điện thoại và tự sắp xếp lịch mà không có bất kỳ công cụ hỗ trợ nào, dẫn đến nhiều trường hợp hẹn trùng giờ hoặc đến nơi mới biết phòng đã được thuê trước đó.

Về phía chủ trọ, việc phải tiếp nhận yêu cầu xem phòng đồng thời qua nhiều kênh rời rạc như điện thoại, Zalo, Facebook Messenger khiến việc theo dõi và quản lý lịch hẹn trở nên lộn xộn, dễ bỏ sót hoặc nhầm lẫn, đặc biệt khi cùng lúc nhiều người hỏi về cùng một phòng.

Xuất phát từ những bất cập trên, tác giả đề xuất xây dựng ứng dụng **Tìm Trọ 24/7**, một nền tảng di động Android kết nối trực tiếp người tìm phòng và người cho thuê, hướng đến bốn nhóm đối tượng sử dụng:

- **Khách truy cập (chưa đăng nhập):** Duyệt danh sách phòng trọ, tìm kiếm và lọc theo khu vực địa lý, mức giá và tiện ích; xem thông tin chi tiết từng phòng, xem vị trí trên bản đồ và gọi điện trực tiếp cho chủ trọ, tất cả mà không cần tạo tài khoản.
- **Người thuê (đã đăng nhập):** Đặt lịch hẹn xem phòng với ngày giờ cụ thể, theo dõi trạng thái lịch hẹn theo thời gian thực, nhắn tin trực tiếp với chủ trọ, lưu tin yêu thích, nhận gợi ý từ trợ lý AI tìm phòng chạy hoàn toàn offline trên thiết bị, và nộp hồ sơ xác minh CCCD để được cấp quyền đăng tin.
- **Người cho thuê (đã xác minh CCCD):** Đăng tin phòng trọ kèm hình ảnh thực tế và định vị bản đồ; chỉnh sửa, xóa tin; phê duyệt hoặc từ chối lịch hẹn từ người thuê; đánh dấu phòng đã cho thuê (hệ thống tự động hủy các lịch hẹn còn lại); và nâng cấp vị trí tin đăng thông qua hệ thống thanh toán tích hợp.
- **Quản trị viên:** Kiểm duyệt bài đăng, xét duyệt hồ sơ xác minh CCCD, quản lý và khóa/mở khóa tài khoản người dùng, xử lý yêu cầu hỗ trợ kỹ thuật, theo dõi thống kê hệ thống trên dashboard và xuất dữ liệu báo cáo, tất cả thông qua bảng điều khiển web riêng biệt.

Ứng dụng không cạnh tranh trực tiếp với các sàn bất động sản lớn mà tập trung vào phân khúc phòng trọ bình dân, nơi người thuê quan tâm nhiều nhất đến sự xác thực của thông tin và khả năng liên hệ nhanh với chủ trọ.
...
Khách truy cập là người dùng mở ứng dụng mà chưa có tài khoản hoặc chưa đăng nhập. Đây là nhóm người dùng phổ biến nhất trong giai đoạn đầu tiếp cận ứng dụng, thường chỉ muốn xem thông tin trước khi quyết định tạo tài khoản. Ứng dụng cho phép nhóm này truy cập đầy đủ các thông tin công khai mà không yêu cầu xác thực:

- Xem danh sách phòng trọ trên trang chủ.
- Tìm kiếm và lọc phòng trọ theo nhiều tiêu chí.
- Xem thông tin chi tiết từng phòng trọ.
- Gọi điện trực tiếp cho chủ trọ.
- Xem vị trí phòng trọ trên bản đồ Google Maps.

Khi khách truy cập thực hiện các thao tác yêu cầu đăng nhập như đặt lịch hẹn, nhắn tin hay lưu tin yêu thích, ứng dụng sẽ hiển thị hộp thoại thông báo và chuyển hướng sang màn hình đăng nhập. Trợ lý AI tìm phòng cũng chỉ hoạt động khi người dùng đã đăng nhập.

### 1.2.2 Yêu cầu đối với người thuê (đã đăng nhập)

Người thuê là người dùng đã tạo tài khoản và đăng nhập thành công. Ngoài các quyền truy cập công khai của khách truy cập, nhóm này được sử dụng các chức năng yêu cầu xác thực:

- Đăng nhập, cập nhật hồ sơ cá nhân, đổi mật khẩu và khôi phục mật khẩu.
- Lưu phòng trọ yêu thích.
- Đặt lịch hẹn xem phòng với ngày và khung giờ cụ thể.
- Theo dõi và quản lý trạng thái lịch hẹn theo thời gian thực.
- Nhắn tin trực tiếp với chủ trọ.
- Sử dụng trợ lý AI tìm phòng chạy offline trên thiết bị.
- Gửi yêu cầu hỗ trợ kỹ thuật đến quản trị viên.
- Nộp hồ sơ xác minh CCCD để được cấp quyền đăng tin.

### 1.2.3 Yêu cầu đối với người cho thuê (đã xác minh CCCD)

Người cho thuê là người dùng đã xác minh danh tính bằng CCCD và được quản trị viên phê duyệt. Ngoài các quyền của người thuê, nhóm này được sử dụng các chức năng quản lý tin đăng và lịch hẹn:

- Đăng tin phòng trọ kèm hình ảnh, vị trí bản đồ và thông tin chi tiết.
- Chỉnh sửa hoặc xóa tin đăng.
- Đánh dấu phòng đã cho thuê (hệ thống tự động hủy các lịch hẹn còn lại).
- Phê duyệt hoặc từ chối lịch hẹn xem phòng từ người thuê.
- Quản lý danh sách bài đăng và theo dõi trạng thái kiểm duyệt.
- Nâng cấp bài đăng lên vị trí nổi bật hoặc mua thêm lượt đăng tin qua QR thanh toán.
- Sử dụng trợ lý AI tìm phòng chạy offline trên thiết bị.

### 1.2.4 Yêu cầu đối với quản trị viên

Quản trị viên vận hành hệ thống thông qua bảng điều khiển web riêng biệt, không sử dụng ứng dụng di động:

- Xem, khóa và mở khóa tài khoản người dùng.
- Kiểm duyệt bài đăng phòng trọ: phê duyệt hoặc từ chối kèm lý do.
- Xóa bài đăng vi phạm.
- Xét duyệt hồ sơ xác minh CCCD của người cho thuê.
- Xét duyệt yêu cầu nâng cấp bài đăng nổi bật sau khi người cho thuê thanh toán.
- Theo dõi danh sách lịch hẹn xem phòng và hủy lịch hẹn khi cần thiết.
- Tiếp nhận và xử lý yêu cầu hỗ trợ kỹ thuật từ người dùng.
- Theo dõi thống kê số liệu tổng quan trên dashboard.
- Xuất danh sách người dùng và bài đăng ra file Excel.
- Quét và xóa các tài khoản không hoạt động theo mốc thời gian tùy chọn.

### 1.2.5 Yêu cầu đối với chức năng đặt lịch hẹn và quản lý lịch hẹn

- Cho phép người thuê gửi yêu cầu đặt lịch xem phòng với ngày, giờ cụ thể.
- Cho phép người thuê chỉnh sửa lịch hẹn đang chờ xác nhận, tối đa 3 lần.
- Cho phép người cho thuê xác nhận hoặc từ chối lịch hẹn kèm lý do.
- Cho phép người cho thuê hủy lịch hẹn đã xác nhận và giải phóng khung giờ.
- Cho phép người thuê hủy lịch hẹn và giải phóng khung giờ đã đặt.
- Ngăn trùng lịch trong cùng khung giờ bằng cơ chế khóa khung giờ trên Firestore.
- Gửi thông báo đẩy khi lịch hẹn thay đổi trạng thái và nhắc nhở trước thời điểm hẹn.
- Sau khi qua thời điểm hẹn, cho phép người cho thuê đánh dấu kết quả: đã đến xem hoặc không đến.
- Tự động chuyển lịch hẹn sang hết hạn nếu người cho thuê không xác nhận trong 48 giờ.
- Tự động hủy toàn bộ lịch hẹn còn lại khi chủ trọ đánh dấu phòng đã cho thuê.
- Hiển thị lịch hẹn với đầy đủ trạng thái: chờ xác nhận, đã xác nhận, hai bên xác nhận, từ chối, hết hạn chờ, người thuê hủy, chủ hủy, không đến, hoàn thành, đã thuê.

### 1.2.6 Yêu cầu phi chức năng

- Giao diện thân thiện, dễ sử dụng trên thiết bị di động.
- Dữ liệu bảo mật bằng Firestore Security Rules và Firebase Storage Rules.
- Xác thực người dùng qua Firebase Authentication, mật khẩu tối thiểu 12 ký tự.
- Dữ liệu đồng bộ theo thời gian thực qua Firestore.
- Hệ thống mở rộng tự động với Firebase Serverless.
- Hỗ trợ bản đồ Google Maps để hiển thị vị trí phòng trọ.
...
- **IDE & SDK:** Android Studio Ladybug 2024, minSdk 24 (Android 7.0), targetSdk 35 (Android 15)
- **Android Jetpack:** LiveData, ViewModel, CameraX, ViewBinding
- **Thư viện hình ảnh:** Glide 4.16.0
- **OCR on-device:** ML Kit Text Recognition 16.0.1
- **HTTP Client:** OkHttp 4.12.0
- **AI Chatbot:** ChatbotEngine — BM25 + Cosine Similarity, chạy hoàn toàn on-device, không cần internet
- **Render Markdown:** Markwon 4.6.2
- **Giao diện:** Material Design 3, màu chủ đạo xanh lam
...
- **Thuật toán BM25 (Okapi BM25) và Cosine Similarity:** Chuyển đổi câu hỏi của người dùng và các mẫu ý định (patterns) thành các vector BM25 và tính toán độ tương đồng Cosine để xác định ý định người dùng (Intent Matching) với độ chính xác cao mà không cần kết nối Internet.
...
| **Điều kiện thành công** | Tài khoản được tạo thành công; email xác thực được gửi đến hộp thư của người dùng; người dùng được chuyển về màn hình đăng nhập |
| **Điều kiện thất bại** | Tài khoản không được tạo; người dùng vẫn ở màn hình đăng ký với thông báo lỗi tương ứng |
| **Luồng sự kiện chính** | 1. Người dùng nhấn "Đăng ký" tại màn hình đăng nhập<br>2. Hệ thống hiển thị form đăng ký<br>3. Người dùng nhập họ tên (2–50 ký tự), số điện thoại (10 số, đầu số 03/05/07/08/09), email Gmail, mật khẩu (tối thiểu 12 ký tự, có chữ hoa, chữ số và ký tự đặc biệt) và xác nhận mật khẩu<br>4. Người dùng nhấn "Tạo tài khoản"<br>5. Hệ thống kiểm tra tính hợp lệ của toàn bộ thông tin nhập vào<br>6. Hệ thống kiểm tra số điện thoại chưa được đăng ký trong hệ thống<br>7. Hệ thống tạo tài khoản Firebase Authentication; ghi thông tin người dùng vào Firestore và đăng ký số điện thoại vào phone_registry bằng một batch transaction nguyên tử<br>8. Hệ thống gửi email xác thực đến địa chỉ Gmail vừa đăng ký<br>9. Hệ thống hiển thị thông báo thành công, đăng xuất phiên hiện tại và chuyển người dùng về màn hình đăng nhập để xác thực email trước khi sử dụng |
| **Luồng thay thế** | Không có |
| **Luồng ngoại lệ** | 5a. Họ tên không hợp lệ (dưới 2 ký tự, trên 50 ký tự, hoặc chứa ký tự đặc biệt) — hiển thị lỗi tại ô nhập, quay lại bước 3<br>5b. Email không đúng định dạng hoặc không phải địa chỉ Gmail — hiển thị lỗi tại ô nhập, quay lại bước 3<br>5c. Số điện thoại không đúng định dạng 10 số đầu số Việt Nam — hiển thị lỗi tại ô nhập, quay lại bước 3<br>5d. Mật khẩu không đủ điều kiện (dưới 12 ký tự, thiếu chữ hoa, thiếu chữ số hoặc thiếu ký tự đặc biệt) — hiển thị lỗi tại ô nhập, quay lại bước 3<br>5e. Mật khẩu xác nhận không khớp với mật khẩu đã nhập — hiển thị lỗi tại ô xác nhận, quay lại bước 3<br>6a. Số điện thoại đã được đăng ký cho tài khoản khác — hiển thị thông báo lỗi, quay lại bước 3<br>7a. Email đã tồn tại trên hệ thống — hiển thị thông báo lỗi, quay lại bước 3<br>7b. Lỗi ghi dữ liệu Firestore — hệ thống tự động xóa tài khoản Firebase Authentication vừa tạo (rollback) để tránh dữ liệu không đồng bộ; hiển thị thông báo lỗi, quay lại bước 3<br>*. Người dùng thử đăng ký quá 3 lần trong vòng 60 giây — hệ thống từ chối yêu cầu và thông báo thời gian chờ (rate limiting) |
...
| **Mục đích** | Cho phép người dùng và quản trị viên đã có tài khoản xác thực và truy cập hệ thống |
| **Mức độ ưu tiên** | Bắt Buộc |
| **Điều kiện kích hoạt** | Khi người dùng hoặc quản trị viên nhấn nút "Đăng nhập" |
| **Điều kiện tiên quyết** | Người dùng hoặc quản trị viên đã có tài khoản đăng ký trong hệ thống |
| **Điều kiện thành công** | Người dùng hoặc quản trị viên đăng nhập thành công và được chuyển đến màn hình tương ứng |
| **Điều kiện thất bại** | Người dùng hoặc quản trị viên không thể truy cập hệ thống; vẫn ở màn hình đăng nhập với thông báo lỗi tương ứng |
| **Luồng sự kiện chính** | 1. Tác nhân nhập email và mật khẩu<br>2. Tác nhân nhấn "Đăng nhập"<br>3. Hệ thống kiểm tra tính hợp lệ của đầu vào và giới hạn số lần thử đăng nhập<br>4. Hệ thống xác thực thông tin đăng nhập qua Firebase Authentication<br>5. Hệ thống kiểm tra trạng thái xác minh email của tài khoản<br>6. Hệ thống cập nhật token FCM cho thiết bị hiện tại<br>7. Hệ thống kiểm tra trạng thái khóa của tài khoản trong Firestore<br>8. Hệ thống đăng ký nhận thông báo broadcast và chuyển tác nhân đến màn hình tương ứng |
| **Luồng thay thế** | Không có |
| **Luồng ngoại lệ** | 3a. Email hoặc mật khẩu để trống — hiển thị lỗi tại ô nhập tương ứng, quay lại bước 1<br>3b. Tác nhân đã thử đăng nhập quá 5 lần trong vòng 60 giây — hệ thống từ chối yêu cầu và thông báo thời gian chờ (rate limiting)<br>4a. Email hoặc mật khẩu không đúng — hiển thị dialog thông báo lỗi, quay lại bước 1<br>4b. Tài khoản bị vô hiệu hóa bởi hệ thống — thông báo lỗi<br>4c. Lỗi kết nối mạng — thông báo kiểm tra kết nối, quay lại bước 1<br>5a. Email chưa được xác minh — hệ thống đăng xuất phiên, hiển thị dialog thông báo kèm tùy chọn "Gửi lại email xác minh", quay lại bước 1<br>7a. Tài khoản đang bị khóa và chưa hết hạn — hiển thị dialog thông báo lý do khóa, thời gian khóa và thời điểm mở khóa; hệ thống lắng nghe real-time và tự động điều hướng vào ứng dụng ngay khi quản trị viên mở khóa |
...
| **Điều kiện tiên quyết** | Người dùng đã có tài khoản đăng ký trong hệ thống |
| **Điều kiện thành công** | Hệ thống xử lý yêu cầu thành công và hiển thị thông báo liên kết đặt lại đã được gửi đến hộp thư |
| **Điều kiện thất bại** | Yêu cầu không được xử lý; người dùng vẫn ở màn hình với thông báo lỗi tương ứng |
| **Luồng sự kiện chính** | 1. Người dùng nhấn "Quên mật khẩu" tại màn hình đăng nhập<br>2. Hệ thống hiển thị màn hình nhập email<br>3. Người dùng nhập địa chỉ email và nhấn "Gửi"<br>4. Hệ thống kiểm tra giới hạn số lần gửi yêu cầu và tính hợp lệ của email<br>5. Hệ thống gửi liên kết đặt lại mật khẩu qua Firebase Authentication<br>6. Hệ thống hiển thị thông báo xác nhận; người dùng được chuyển về màn hình đăng nhập |
| **Luồng thay thế** | Không có |
| **Luồng ngoại lệ** | 4a. Người dùng đã gửi quá 3 yêu cầu trong vòng 120 giây — hệ thống từ chối và thông báo thời gian chờ (rate limiting)<br>4b. Email để trống — hiển thị lỗi tại ô nhập, quay lại bước 3<br>4c. Email không đúng định dạng — hiển thị lỗi tại ô nhập, quay lại bước 3<br>4d. Email không có đuôi @gmail.com — hiển thị lỗi tại ô nhập, quay lại bước 3<br>5a. Lỗi kết nối mạng — hiển thị thông báo lỗi, quay lại bước 3 |
...
| **Mục đích** | Cho phép người cho thuê đăng phòng trọ lên hệ thống để người thuê tìm kiếm |
| **Mức độ ưu tiên** | Bắt Buộc |
| **Điều kiện kích hoạt** | Khi người cho thuê nhấn nút "Đăng tin mới" |
| **Điều kiện tiên quyết** | Người cho thuê đã đăng nhập, đã xác minh CCCD thành công và đã qua thời gian chờ 24 giờ sau khi được phê duyệt |
| **Điều kiện thành công** | Tin đăng được tạo thành công ở trạng thái chờ xét duyệt |
| **Điều kiện thất bại** | Tin đăng không được tạo; người cho thuê vẫn ở form đăng tin với thông báo lỗi |
| **Luồng sự kiện chính** | 1. Người cho thuê nhấn "Đăng tin mới"<br>2. Hệ thống kiểm tra hạn mức đăng tin miễn phí (3 tin miễn phí/ngày) hoặc slot đã mua<br>3. Hệ thống hiển thị form đăng tin<br>4. Người cho thuê nhập đầy đủ thông tin: tiêu đề, địa chỉ, diện tích, giá thuê, hạn hiển thị, khung giờ nhận lịch hẹn, tiện ích, quy định, tải lên ảnh phòng<br>5. Người cho thuê nhấn "Đăng tin"<br>6. Hệ thống kiểm tra tính hợp lệ của thông tin và xác nhận lại hạn mức đăng tin<br>7. Hệ thống nén ảnh, tải lên Firebase Storage và lưu bài đăng ở trạng thái chờ xét duyệt đồng thời<br>8. Hệ thống thông báo đăng tin thành công |
| **Luồng thay thế** | 2b. Hết hạn mức đăng tin miễn phí nhưng còn slot đã mua — hệ thống gợi ý sử dụng slot đã mua; người cho thuê xác nhận sử dụng slot, tiếp tục từ bước 3 |
| **Luồng ngoại lệ** | 2a. Đã hết hạn mức đăng tin miễn phí và không có slot đã mua — hệ thống thông báo và gợi ý mua thêm slot, không hiển thị form đăng tin<br>5a. Thiếu thông tin bắt buộc — thông báo lỗi tại các trường tương ứng, quay lại bước 4<br>6a. Hạn mức đăng tin đã hết tại thời điểm xác nhận — thông báo hết hạn mức, gợi ý mua thêm slot |
...
### 3.2.2. Cloud Firestore – Thiết kế cơ sở dữ liệu
...
### 3.2.4. Firebase Cloud Messaging (FCM)
...
|---|---|---|---|
| users | Bắt buộc đăng nhập | Chính chủ hoặc quản trị viên | • Chỉ cho phép thay đổi vai trò hợp lệ<br>• Mặc định là người thuê khi tạo mới |
| rooms | Công khai với phòng đã duyệt hoặc hết hạn. Bắt buộc đăng nhập với phòng đã cho thuê hoặc phòng của chính chủ | Chủ sở hữu đã xác minh hoặc quản trị viên | • Người đăng phải hoàn tất xác minh danh tính<br>• Không trong thời gian bị phạt khóa quyền đăng bài |
| appointments | Bắt buộc đăng nhập | Người thuê tạo lịch mới ở trạng thái chờ. Cả hai bên được phép cập nhật | • Cố định thông tin hai bên và phòng trọ sau khi tạo<br>• Người tham gia có quyền xóa lịch hẹn |
| bookedSlots | Bắt buộc đăng nhập | Chủ trọ tạo mới. Người tham gia có quyền cập nhật và xóa | • Tạo bằng giao dịch đồng bộ để khóa giờ khi xác nhận lịch hẹn<br>• Tự động xóa khi lịch hẹn bị hủy hoặc hoàn tất |
| verifications | Chính chủ hoặc quản trị viên | Chính chủ hoặc quản trị viên | • Chỉ cho phép thao tác khi hồ sơ đang chờ duyệt |
| support_tickets | Chủ phiếu hoặc quản trị viên | Chủ phiếu tạo mới. Cả hai bên cập nhật. Chỉ quản trị viên được xóa | • Phân hệ tin nhắn nội bộ chỉ cho phép quản trị viên và chủ phiếu truy cập |
| savedPosts | Chính chủ, chủ phòng hoặc quản trị viên | Chính chủ tạo mới. Chính chủ hoặc quản trị viên cập nhật và xóa | — |
| notifications | Chủ thông báo hoặc quản trị viên | Bắt buộc đăng nhập để tạo mới. Chủ thông báo được cập nhật hoặc xóa | • Mã người gửi phải khớp tuyệt đối với phiên đăng nhập để chống giả mạo |
| chats | Người tham gia hội thoại | Người tham gia hội thoại | • Phân hệ tin nhắn chỉ cho phép người tham gia truy cập<br>• Mã người gửi phải khớp tuyệt đối để bảo mật |
| cccd_registry | Bắt buộc đăng nhập | Chính chủ được tạo và cập nhật. Chỉ quản trị viên được xóa | • Mỗi số căn cước chỉ được liên kết với một tài khoản duy nhất |
...
| `support_images/{ticketId}` | Chủ phiếu hoặc admin | Chủ phiếu, admin hoặc khi tạo phiếu mới |
| (mặc định) | Từ chối | Từ chối |

### 3.2.6. Cloud Functions (Node.js)

Cloud Functions v2 được triển khai tại cụm máy chủ Đông Nam Á (Singapore) nhằm tối ưu tốc độ cho người dùng Việt Nam. Hệ thống máy chủ được chia thành 5 nhóm xử lý tự động:

*   **Quản lý đặt lịch hẹn & đăng tin:**
    *   Kiểm tra chặt chẽ các giới hạn đặt lịch (hạn mức phòng trong ngày, hạn mức chờ của người thuê).
    *   Sử dụng giao dịch đồng bộ (transaction) để khóa khung giờ, triệt để ngăn chặn tình trạng hai người đặt trùng một thời điểm (race condition).
    *   Kiểm tra và trừ số lượt đăng tin của chủ trọ trước khi hệ thống cho phép bài đăng mới xuất hiện.
*   **Thống kê và Bảng điều khiển (Dashboard):**
    *   Tổng hợp khối lượng lớn dữ liệu thống kê cho Web Admin.
    *   Áp dụng cơ chế lưu trữ đệm (cache) với thời gian làm mới 5 phút để giảm thiểu chi phí truy vấn cơ sở dữ liệu.
*   **Xác minh danh tính (OCR):**
    *   Tự động bắt sự kiện khi có hồ sơ căn cước mới được gửi lên.
    *   Kết nối với Google Cloud Vision API để trích xuất tự động họ tên, số thẻ, ngày sinh và địa chỉ, giúp rút ngắn thời gian phê duyệt thủ công.
*   **Tích hợp thanh toán SePay:**
    *   Lắng nghe thông báo (Webhook) từ ngân hàng để đối chiếu mã giao dịch và tự động duyệt thanh toán.
    *   Hệ thống quét dự phòng định kỳ để đảm bảo không bỏ sót giao dịch khi mạng gặp sự cố.
*   **Tự động hóa hệ thống:**
    *   Chạy ngầm định kỳ mỗi phút để quét và tự động mở khóa các tài khoản người dùng đã hết thời gian chịu phạt.
...
Mã nguồn ứng dụng được tổ chức theo kiến trúc MVVM, chia thành 5 thư mục chính để dễ quản lý và nâng cấp:

*   **Thư mục màn hình giao diện:** Chứa các màn hình của ứng dụng (đăng nhập, trang chủ, nhắn tin...). Chịu trách nhiệm hiển thị giao diện và nhận thao tác chạm của người dùng.
*   **Thư mục xử lý dịch vụ Firebase:** Chuyên giao tiếp trực tiếp với máy chủ Firebase để thực hiện các lệnh thêm, sửa, xóa và tải dữ liệu.
*   **Thư mục quản lý model dữ liệu:** Định nghĩa các khuôn mẫu dữ liệu (như người dùng, phòng trọ, lịch hẹn). Giúp chuyển đổi dữ liệu thô từ máy chủ thành các đối tượng dễ sử dụng.
*   **Thư mục quản lý trạng thái:** Đóng vai trò cầu nối. Lấy dữ liệu từ thư mục Firebase, xử lý tính toán, sau đó tự động đẩy dữ liệu lên màn hình để hiển thị.
*   **Thư mục component dùng chung:** Chứa các tính năng dùng chung cho nhiều màn hình (như đổi định dạng tiền tệ, xử lý bản đồ) và mã nguồn của trợ lý ảo AI.

### 3.3.2. Thiết kế giao diện người dùng

Giao diện ứng dụng tuân theo hệ thống thiết kế Material Design 3 của Google với bảng màu chủ đạo xanh lam, đảm bảo tính nhất quán và thân thiện với người dùng Android. Điều hướng chính được thực hiện qua Bottom Navigation Bar với bốn tab: Trang chủ, Tìm kiếm, Đăng tin và Hồ sơ. Năm giao diện đặc biệt nổi bật thể hiện quy trình nghiệp vụ cốt lõi của ứng dụng bao gồm:

*   **Giao diện Trợ lý ảo AI:** Điểm nhấn về trí tuệ nhân tạo và xử lý ngôn ngữ tự nhiên (NLP) trên thiết bị. Từ mọi màn hình, người dùng bấm vào biểu tượng AI ở trung tâm thanh điều hướng để mở màn hình trợ lý ảo và gõ câu hỏi tìm phòng.
*   **Giao diện Xác minh CCCD:** Điểm nhấn về tương tác phần cứng và thị giác máy tính (Google Cloud Vision OCR). Từ màn hình hồ sơ, người dùng bấm nút nâng cấp tài khoản để chuyển sang giao diện quét, đưa CCCD vào khung camera để hệ thống trích xuất thông tin.
*   **Giao diện Bản đồ & Tìm kiếm:** Điểm nhấn về tích hợp Google Maps và xử lý lọc dữ liệu theo tọa độ. Từ trang chủ, người dùng chọn biểu tượng bản đồ để chuyển sang màn hình tìm kiếm, quan sát vị trí phòng trọ trực quan và kéo thanh trượt để lọc.
*   **Giao diện Đặt lịch hẹn:** Điểm nhấn về xử lý giao dịch đồng bộ (transaction), chống đặt trùng lịch và cập nhật trạng thái thời gian thực. Từ màn hình chi tiết phòng trọ, người dùng bấm nút "Đặt lịch xem phòng" để mở giao diện lịch và chốt giờ hẹn.
*   **Giao diện Đăng tin phòng trọ:** Điểm nhấn về tối ưu trải nghiệm nhập liệu và xử lý tải ảnh đa phương tiện. Từ thanh điều hướng chính, người dùng chọn tab "Đăng tin" để mở giao diện điền form mô tả, tải lên hình ảnh thực tế và định vị bản đồ.

**Bảng 3.6: Các màn hình chính của ứng dụng**

| Màn hình | Vai trò | Chức năng chính |
|---|---|---|
| Đăng nhập / Đăng ký | Tất cả | Xác thực tài khoản qua email Gmail và mật khẩu |
| Trang chủ | Người dùng | Thanh tìm kiếm nhanh, khu vực phổ biến, tin nổi bật, tin mới nhất |
| Tìm kiếm nâng cao | Người dùng | Lọc phòng theo địa chỉ, khoảng giá, diện tích, tiện ích; kết quả phân trang |
| Chi tiết phòng trọ | Người dùng | Thư viện ảnh, giá, tiện ích, quy định, thông tin chủ trọ; nút Đặt lịch và Nhắn tin |
| Đặt lịch hẹn | Người dùng | Chọn ngày qua calendar, chọn khung giờ còn trống, nhập ghi chú |
| Lịch hẹn của tôi | Người dùng | Danh sách lịch hẹn kèm trạng thái, cập nhật thời gian thực |
| Nhắn tin | Người dùng, Người cho thuê | Danh sách hội thoại; giao diện chat văn bản và ảnh; emoji reaction |
| Xác minh CCCD | Người cho thuê | CameraX chụp mặt trước/sau CCCD; hiển thị kết quả OCR để xác nhận |
| Đăng tin phòng trọ | Người cho thuê | Form thông tin phòng, tải nhiều ảnh, chọn tiện ích, hiển thị số slot còn lại |
| Quản lý tin đăng | Người cho thuê | Danh sách phòng kèm nhãn trạng thái duyệt; chỉnh sửa và xóa tin |
| Quản lý yêu cầu đặt lịch | Người cho thuê | Danh sách yêu cầu kèm thông tin người đặt; xác nhận hoặc từ chối |
| Hồ sơ cá nhân | Tất cả | Xem và chỉnh sửa thông tin; trạng thái xác minh; đăng xuất |
| Hỗ trợ kỹ thuật | Tất cả | Tạo phiếu hỗ trợ; danh sách phiếu đã gửi; nhận phản hồi từ admin |
| Trợ lý AI | Tất cả | Trợ lý AI on-device (BM25 + Cosine Similarity); lưu lịch sử hội thoại |

### 3.3.3. Luồng hoạt động các chức năng cốt lõi

**a. Luồng đăng ký và đăng nhập**

Khi người dùng nhấn "Đăng ký", ứng dụng thu thập địa chỉ email Gmail, mật khẩu và số điện thoại. Trước khi tạo tài khoản, ứng dụng truy vấn collection phone_registry để kiểm tra số điện thoại chưa được đăng ký trước đó. Sau khi vượt qua kiểm tra trùng lặp, tài khoản được tạo trên Firebase Authentication và hồ sơ người dùng được khởi tạo trong Firestore với vai trò mặc định là người thuê, chưa xác minh danh tính. Số điện thoại được ghi vào phone_registry để ngăn đăng ký thêm tài khoản. FCM token của thiết bị được ghi nhận vào Firestore ngay sau đăng nhập thành công.

**b. Luồng đăng tin phòng trọ**

Chỉ người cho thuê đã hoàn thành xác minh CCCD mới được đăng tin. Khi người dùng gửi bài đăng, `CheckPostQuotaUseCase` kiểm tra hạn mức, trong đó mỗi người dùng được đăng tối đa ba bài miễn phí trong 24 giờ (FREE_POSTS_PER_DAY = 3). Nếu còn quota, ứng dụng tạo document phòng trong Firestore ở trạng thái pending, tải ảnh lên Firebase Storage và cập nhật đường dẫn ảnh vào document. Quản trị viên xem xét và duyệt bài qua Web Admin; khi được duyệt, tin đăng chuyển sang trạng thái approved và xuất hiện trong kết quả tìm kiếm.

**c. Luồng đặt lịch hẹn xem phòng**

Người dùng chọn ngày và khung giờ trên giao diện BookingActivity. Thay vì ghi trực tiếp vào Firestore, ứng dụng gọi Cloud Function `serverSubmitBooking` qua HTTPS Callable. Phía máy chủ, hàm thực hiện ba bước kiểm tra: xác nhận người thuê chưa vượt giới hạn lịch hẹn đang hoạt động, kiểm tra phòng chưa đạt giới hạn ngày, và thực hiện Firestore transaction nguyên tử để kiểm tra slot và ghi document lịch hẹn vào appointments với trạng thái pending. Document bookedSlots được chủ trọ tạo sau khi xác nhận lịch hẹn để khóa khung giờ. Cơ chế transaction đảm bảo rằng ngay cả khi nhiều người dùng đặt cùng một khung giờ đồng thời, chỉ một yêu cầu được chấp nhận, các yêu cầu sau nhận lỗi slot đã bị đặt. Sau khi đặt thành công, Cloud Function gửi thông báo FCM đến người cho thuê.

**d. Luồng xác minh danh tính CCCD**

Người cho thuê mở CccdCameraActivity để chụp mặt trước và mặt sau CCCD bằng CameraX. Ứng dụng chạy ML Kit Text Recognition on-device để trích xuất thông tin ngay trên thiết bị. Nếu kết quả nhận dạng on-device không đạt đủ độ chính xác, ảnh CCCD được tải lên Firebase Storage và Cloud Function `autoReviewVerificationByCloudVision` gọi Google Cloud Vision API để xử lý lại với độ chính xác cao hơn. Kết quả OCR (họ tên, số CCCD, ngày sinh, địa chỉ) được hiển thị để người dùng xác nhận trước khi gửi hồ sơ. Quản trị viên phê duyệt cuối cùng qua Web Admin; sau khi phê duyệt, tài khoản được nâng lên vai trò người cho thuê và số CCCD được đăng ký vào cccd_registry.

---

## 3.4. Thiết kế bảng điều khiển quản trị (Web Admin)

### 3.4.1. Kiến trúc và cấu trúc mã nguồn

Bảng điều khiển quản trị được xây dựng bằng Vanilla JavaScript (ES6+) kết hợp Firebase JS SDK và được triển khai trên Firebase Hosting. Toàn bộ giao diện hoạt động theo mô hình Single Page Application, điều hướng giữa các trang không yêu cầu tải lại trình duyệt. Mã nguồn phía client được tổ chức thành 14 tệp JavaScript đặt trong thư mục `public/js/`, mỗi tệp phụ trách một nhóm chức năng riêng biệt.

**Bảng 3.7: Tệp mã nguồn bảng điều khiển Web Admin**

| Tệp | Chức năng |
|---|---|
| 00-globals.js | Biến toàn cục và cấu hình phân trang |
| 01-firebase-config.js | Khởi tạo kết nối Firebase |
| 02-helpers.js | Hàm tiện ích: định dạng dữ liệu, toast, hộp thoại xác nhận |
| 03-auth.js | Xử lý xác thực quản trị viên và điều hướng trang |
| 04-navigation.js | Điều hướng giữa các trang trong bảng điều khiển |
| 05-dashboard.js | Tải thống kê từ cache máy chủ và vẽ biểu đồ (Chart.js) |
| 06-verifications.js | Quản lý yêu cầu xác minh CCCD |
| 07-posts.js | Kiểm duyệt tin đăng phòng trọ |
| 08-users.js | Quản lý người dùng, khóa/mở khóa tài khoản |
| 09-exports.js | Xuất dữ liệu ra file Excel (thư viện XLSX) |
| 10-featured-payments.js | Quản lý thanh toán tin đăng nổi bật |
| 11-support.js | Quản lý và phản hồi phiếu hỗ trợ kỹ thuật |
| 12-utils.js | Hàm tiện ích bổ sung dùng chung |
| 13-appointments.js | Quản lý và theo dõi lịch hẹn |

### 3.4.2. Các chức năng quản trị

Web Admin cung cấp sáu nhóm chức năng chính. Dashboard tổng quan hiển thị bốn thẻ thống kê (tổng người dùng, tổng tin đăng, tổng lịch hẹn, số hồ sơ xác minh chờ duyệt) cùng biểu đồ cột tăng trưởng sáu tháng và biểu đồ tròn phân loại người dùng. Dữ liệu thống kê được cung cấp bởi Cloud Function `getDashboardStats`, hàm này duy trì một document cache tại `stats/dashboard_stats` trên Firestore với thời gian sống là năm phút, tránh đọc toàn bộ collection mỗi lần tải trang.

Chức năng kiểm duyệt tin đăng cho phép quản trị viên xem đầy đủ ảnh và thông tin phòng, sau đó duyệt hoặc từ chối kèm lý do. Chức năng phê duyệt xác minh CCCD hiển thị ảnh CCCD gốc và kết quả trích xuất OCR để quản trị viên đối chiếu và phê duyệt hoặc từ chối hồ sơ. Chức năng quản lý người dùng cho phép xem danh sách tài khoản, khóa tài khoản vi phạm có thời hạn xác định; Cloud Function `autoUnlockUsers` chạy theo lịch mỗi phút để tự động mở khóa các tài khoản đã hết thời hạn khóa. Chức năng quản lý phiếu hỗ trợ cho phép xem nội dung phiếu và phản hồi trực tiếp đến người dùng. Cuối cùng, tính năng xuất báo cáo Excel hỗ trợ xuất danh sách người dùng và tin đăng theo bộ lọc tùy chọn.

---

## 3.5. Kết quả triển khai

Ứng dụng Tìm Trọ 24/7 đã được triển khai và kiểm thử trên thiết bị thực chạy Android. Bảng điều khiển quản trị được triển khai công khai trên Firebase Hosting. Toàn bộ backend vận hành trên hạ tầng Firebase tại khu vực asia-southeast1 (Singapore), đảm bảo độ trễ thấp cho người dùng tại Việt Nam.

**Hình 3.x:** Màn hình trang chủ và tìm kiếm phòng trọ trên ứng dụng Android

**Hình 3.x:** Màn hình chi tiết phòng và đặt lịch hẹn

**Hình 3.x:** Màn hình xác minh CCCD và trợ lý AI

**Hình 3.x:** Bảng điều khiển quản trị — Dashboard và kiểm duyệt nội dung

Quá trình kiểm thử chức năng xác nhận rằng cơ chế Firestore transaction trong `serverSubmitBooking` hoạt động đúng, ngăn chặn đặt trùng khung giờ trong môi trường nhiều người dùng đồng thời. Tính năng OCR nhận dạng CCCD hoạt động ổn định với kết quả nhận dạng on-device đủ chính xác cho đa số trường hợp, và Cloud Vision API xử lý thành công các ảnh có chất lượng thấp hơn. Hệ thống thông báo FCM đảm bảo người cho thuê nhận được cập nhật lịch hẹn trong thời gian thực.
